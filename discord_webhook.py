...
webhook_url = 'https://discord.com/api/webhooks/815975580448063578/ZtiirNnOR3HGGivuM2P-n-AEXyw0vkpllQCwrjowHY03LIX-cuZi_do9xHpnTK_NsFQz'
...
def send_msg(class_name,status,start_time,end_time):
	...
	# Attaches a footer
	webhook.set_footer(text='-- Surendra Pobbati')
